...
class TextHighlighter {
  ...
  _renderMatches(matches) {
    ...
    for (let i = i0; i < i1; i++) {
      ...
      let selectedLeft = 0;
      let queryIdx = findController.state.query.map(x=>x.replaceAll("\n","")).indexOf(match.str);
      ...
      if (begin.divIdx === end.divIdx) {
        selectedLeft = appendTextToDiv(begin.divIdx, begin.offset, end.offset, "highlight m"+queryIdx + highlightSuffix);
      } else {
        selectedLeft = appendTextToDiv(begin.divIdx, begin.offset, infinity.offset, "highlight m"+queryIdx+" begin" + highlightSuffix);
